"""
Django settings for travel_chef_dev_84368 project.
...
ROOT_URLCONF = 'travel_chef_dev_84368.urls'
...
WSGI_APPLICATION = 'travel_chef_dev_84368.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "travel_chef_dev_84368 API",
    "DESCRIPTION": "API documentation for travel_chef_dev_84368 App",
    "VERSION": "v1",
}
